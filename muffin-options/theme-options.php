		...
		$sections['addons'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'sub_desc' 	=> __('Does not affect Retina Logo', 'mfn-opts'),
					'desc' 		=> __('If you use Retina.js please prepare @2x images. More info: <a target="_blank" href="http://imulus.github.io/retinajs/">http://imulus.github.io/retinajs/</a><br />Retina.js disables responsive images in WP 4.4+<br />', 'mfn-opts'),
					'options' 	=> array( '0' => 'Off', '1' => 'On' ),
					'std' 		=> '0'
				),
